...
-- *****************************************************************************
-- Generated on "11/29/2023 20:46:17"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          CPU_DYNASTY
-- 
...
ENTITY CPU_DYNASTY_vhd_vec_tst IS
END CPU_DYNASTY_vhd_vec_tst;
ARCHITECTURE CPU_DYNASTY_arch OF CPU_DYNASTY_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
...
SIGNAL R_A_OUT : STD_LOGIC_VECTOR(15 DOWNTO 0);
SIGNAL R_B_OUT : STD_LOGIC_VECTOR(15 DOWNTO 0);
SIGNAL RAM_OUT : STD_LOGIC_VECTOR(15 DOWNTO 0);
SIGNAL ROM_OUT : STD_LOGIC_VECTOR(15 DOWNTO 0);
SIGNAL RS_OUT : STD_LOGIC_VECTOR(3 DOWNTO 0);
SIGNAL RT_OUT : STD_LOGIC_VECTOR(3 DOWNTO 0);
COMPONENT CPU_DYNASTY
	PORT (
